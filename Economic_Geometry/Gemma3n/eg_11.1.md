...
*   Experiment with Python or R to try out some of the dimensionality reduction and data visualization techniques mentioned in this chapter.
*   Explore online resources and tutorials on data visualization.
*   Look for real-world examples of how dimensionality reduction and data visualization are used in economics.
